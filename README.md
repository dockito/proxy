...
Fork of the amazing https://github.com/jwilder/nginx-proxy to add support to:
...
To run it:
    ...
    $ docker run -d -p 80:80 -v /var/run/docker.sock:/tmp/docker.sock dockito/proxy
...
To run nginx proxy as a separate container you'll need to have [nginx.tmpl](https://github.com/dockito/proxy/blob/master/nginx.tmpl) on your host system.
...
To enable SSL:
    ...
    $ docker run -d -p 80:80 -p 443:443 -v /path/to/certs:/etc/nginx/certs -v /var/run/docker.sock:/tmp/docker.sock dockito/proxy
...
/etc/nginx/htpasswd/$VIRTUAL_HOST
    ...
    $ docker run -d -p 80:80 -p 443:443 -v /path/to/htpasswd:/etc/nginx/htpasswd -v /path/to/certs:/etc/nginx/certs -v /var/run/docker.sock:/tmp/docker.sock dockito/proxy
